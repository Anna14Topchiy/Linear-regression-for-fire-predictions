...
excel_data_don_2014 = pd.read_excel('don_2014_excel.xlsx')
excel_data_don_2016 = pd.read_excel('don_2016_excel.xlsx')
excel_data_don_2018 = pd.read_excel('don_2018_excel.xlsx')

excel_to_csv_don_2014 = excel_data_don_2014.to_csv('don_2014.csv',index=False)
excel_to_csv_don_2016 = excel_data_don_2016.to_csv('don_2016.csv',index=False)
excel_to_csv_don_2018 = excel_data_don_2018.to_csv('don_2018.csv',index=False)

df_don_2014 = pd.read_csv('don_2014.csv')
df_don_2016 = pd.read_csv('don_2016.csv')
df_don_2018 = pd.read_csv('don_2018.csv')

fights_2014 = np.array(df_don_2014['fights']).reshape((-1,1))
fights_2016 = np.array(df_don_2016['fights']).reshape((-1,1))
fights_2018 = np.array(df_don_2018['fights']).reshape((-1,1))

fires_2014 = np.array(df_don_2014['type']).reshape((-1,1))
fires_2016 = np.array(df_don_2016['type']).reshape((-1,1))
fires_2018 = np.array(df_don_2018['type']).reshape((-1,1))
...
plt.xlabel('fires')
plt.ylabel ('fights')
plt.title('Donetsk region 2014', color = 'black', fontname = 'Times New Roman', size = 16, fontweight = 'bold')

plt.subplot(2,2,2)
plt.scatter(X_2016,y_2016)
plt.xlabel('fires')
plt.ylabel ('fights')
plt.title('Donetsk region 2016', color = 'black', fontname = 'Times New Roman', size = 16, fontweight = 'bold')
...
plt.title('Donetsk region 2018', color = 'black', fontname = 'Times New Roman', size = 16, fontweight = 'bold')
...
plt.subplot(3,2,1)   # train don 2014
plt.scatter(X_train_2014,y_train_2014)
plt.plot(X_train_2014,Y_pred_train_2014, color = 'r', label = 'Train')
plt.xlabel('fires')
plt.ylabel ('fights')
plt.legend()
plt.title('Donetsk region 2014', color = 'black', fontname = 'Times New Roman', size = 14, fontweight = 'bold')

plt.subplot(3,2,3)   # train don 2016
plt.scatter(X_train_2016,y_train_2016)
plt.plot(X_train_2016,Y_pred_train_2016, color = 'r', label = 'Train')
plt.xlabel('fires')
plt.ylabel ('fights')
plt.legend()
plt.title('Donetsk region 2016', color = 'black', fontname = 'Times New Roman', size = 14, fontweight = 'bold')

plt.subplot(3,2,5)   # train don 2018
plt.scatter(X_train_2018,y_train_2018)
plt.plot(X_train_2018,Y_pred_train_2018, color = 'r', label = 'Train')
plt.xlabel('fires')
plt.ylabel ('fights')
plt.legend()
plt.title('Donetsk region 2018', color = 'black', fontname = 'Times New Roman', size = 14, fontweight = 'bold')


plt.subplot(3,2,2) # test don 2014
...
plt.subplot(3,2,4) # test don 2016
...
plt.subplot(3,2,6) # test don 2018
